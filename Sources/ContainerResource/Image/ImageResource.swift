...
extension ImageResource {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try mac-container-tool.encode(id, forKey: .id)
        try mac-container-tool.encode(configuration, forKey: .configuration)
        try mac-container-tool.encode(variants, forKey: .variants)
    }

    public init(from decoder: Decoder) throws {
        let mac-container-tool = try decoder.mac-container-tool(keyedBy: CodingKeys.self)
        self.configuration = try mac-container-tool.decode(ImageConfiguration.self, forKey: .configuration)
        self.variants = try mac-container-tool.decode([Variant].self, forKey: .variants)
