...
extension Application {
    public struct MachineDelete: AsyncLoggableCommand {
        ...
        public static let configuration = CommandConfiguration(
            commandName: "delete",
            abstract: "Delete a mac-container-tool machine",
            aliases: ["rm"]
        )
        ...
        public func run() async throws {
            ...
            let progressConfig = try self.progressFlags.makeConfig(
                description: "Deleting mac-container-tool machine"
            )
            ...
            if wasDefault {
                log.info("Deleted default mac-container-tool '\(id)'. Set a new default with 'mac-container-tool machine set-default <id>'.")
            }
        }
    }
}
