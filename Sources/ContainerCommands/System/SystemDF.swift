...
extension Application {
    public struct SystemDF: AsyncLoggableCommand {
        public static let configuration = CommandConfiguration(
            commandName: "df",
            abstract: "Show disk usage for images, mac-container-tools, and volumes"
        )
        ...
        private func diskUsageTable(stats: DiskUsageStats) -> String {
            ...
            rows.append([
                "Containers",
                "\(stats.mac-container-tools.total)",
                "\(stats.mac-container-tools.active)",
                formatSize(stats.mac-container-tools.sizeInBytes),
                formatReclaimable(stats.mac-container-tools.reclaimable, total: stats.mac-container-tools.sizeInBytes),
            ])
