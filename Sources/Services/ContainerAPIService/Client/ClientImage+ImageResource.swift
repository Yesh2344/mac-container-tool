...
extension ClientImage {
    ...
    /// fetched, are skipped.
    public func toImageResource(mac-container-toolSystemConfig: ContainerSystemConfig) async throws -> ImageResource {
        ...
        let displayName = try Self.denormalizeReference(self.description.reference, mac-container-toolSystemConfig: mac-container-toolSystemConfig)
