...
/// Functions for managing local DNS domains for mac-container-tools.
public struct HostDNSResolver {
    ...
    public static let mac-container-toolizationPrefix = "mac-container-toolization."
    ...
    public func createDomain(name: DNSName, localhost: IPAddress? = nil) throws {
        ...
        let resolverFilename = "\(Self.mac-container-toolizationPrefix)\(name)"
    ...
    public func listDomains() -> [DNSName] {
        ...
        return
            filenames
            .filter { $0.starts(with: Self.mac-container-toolizationPrefix) }
