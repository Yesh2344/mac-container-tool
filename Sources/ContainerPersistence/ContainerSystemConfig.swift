...
public final class ContainerSystemConfig: Codable, Sendable, Initable {
    ...
    public let mac-container-tool: ContainerConfig
    ...
    public init(
        ...
        mac-container-tool: ContainerConfig = .init(),
        dns: DNSConfig = .init(),
        ...
        self.build = build
        self.mac-container-tool = mac-container-tool
        self.dns = dns
        self.kernel = kernel
    ...
    public init(from decoder: any Decoder) throws {
        ...
        self.build = try mac-container-tool.decodeIfPresent(BuildConfig.self, forKey: .build) ?? .init()
        self.mac-container-tool = try mac-container-tool.decodeIfPresent(ContainerConfig.self, forKey: .mac-container-tool) ?? .init()
        self.dns = try mac-container-tool.decodeIfPresent(DNSConfig.self, forKey: .dns) ?? .init()
        self.kernel = try mac-container-tool.decodeIfPresent(KernelConfig.self, forKey: .kernel) ?? .init()
        self.machine = try mac-container-tool.decodeIfPresent(MachineConfig.self, forKey: .machine) ?? .init(cpus: nil, memory: nil, homeMount: nil)
        self.network = try mac-container-tool.decodeIfPresent(NetworkConfig.self, forKey: .network) ?? .init()
        self.registry = try mac-container-tool.decodeIfPresent(RegistryConfig.self, forKey: .registry) ?? .init()
        self.vminit = try mac-container-tool.decodeIfPresent(VminitConfig.self, forKey: .vminit) ?? .init()
    }
}
...
final public class BuildConfig: Codable, Sendable {
    ...
    public static var defaultImage: String {
        let tag = String(cString: get_mac-container-tool_builder_shim_version())
        return "ghcr.io/apple/mac-container-tool-builder-shim/builder:\(tag)"
    }
    ...
    public init(from decoder: any Decoder) throws {
        let mac-container-tool = try decoder.mac-container-tool(keyedBy: CodingKeys.self)
        self.rosetta = try mac-container-tool.decodeIfPresent(Bool.self, forKey: .rosetta) ?? Self.defaultRosetta
        self.cpus = try mac-container-tool.decodeIfPresent(Int.self, forKey: .cpus) ?? Self.defaultCPUs
        self.memory = try mac-container-tool.decodeIfPresent(MemorySize.self, forKey: .memory) ?? Self.defaultMemory
        self.image = try mac-container-tool.decodeIfPresent(String.self, forKey: .image) ?? Self.defaultImage
    }
}
...
final public class DNSConfig: Codable, Sendable {
    ...
    public init(from decoder: any Decoder) throws {
        let mac-container-tool = try decoder.mac-container-tool(keyedBy: CodingKeys.self)
        self.domain = try mac-container-tool.decodeIfPresent(String.self, forKey: .domain)
    }
}

final public class VminitConfig: Codable, Sendable {
    public static var defaultImage: String {
        let tag = String(cString: get_swift_mac-container-toolization_version())
        return tag == "latest"
            ? "vminit:latest"
            : "ghcr.io/apple/mac-container-toolization/vminit:\(tag)"
    }
...
final public class KernelConfig: Codable, Sendable {
    public static let defaultBinaryPath = "opt/kata/share/kata-mac-container-tools/vmlinux-6.18.15-186"
    public static let defaultURL: URL =
        URL(string: "https://github.com/kata-mac-container-tools/kata-mac-container-tools/releases/download/3.28.0/kata-static-3.28.0-arm64.tar.zst")!
    ...
    public init(from decoder: any Decoder) throws {
        let mac-container-tool = try decoder.mac-container-tool(keyedBy: CodingKeys.self)
        self.binaryPath =
            try mac-container-tool.decodeIfPresent(String.self, forKey: .binaryPath)
            ?? Self.defaultBinaryPath
        if let urlString = try mac-container-tool.decodeIfPresent(String.self, forKey: .url),
    ...
    // encodes into a keyed mac-container-tool with a "relative" key. Encode as a plain string
    ...
    public func encode(to encoder: any Encoder) throws {
        ...
        try mac-container-tool.encode(binaryPath, forKey: .binaryPath)
        try mac-container-tool.encode(url.absoluteString, forKey: .url)
    }
}
...
final public class RegistryConfig: Codable, Sendable {
    ...
    public init(from decoder: any Decoder) throws {
        let mac-container-tool = try decoder.mac-container-tool(keyedBy: CodingKeys.self)
        self.domain = try mac-container-tool.decodeIfPresent(String.self, forKey: .domain) ?? Self.defaultDomain
    }
}
