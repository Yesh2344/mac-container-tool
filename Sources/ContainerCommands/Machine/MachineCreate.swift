...
extension Application {
    public struct MachineCreate: AsyncLoggableCommand {
        ...
        public static let configuration = CommandConfiguration(
            commandName: "create",
            abstract: "Create a new mac-container-tool machine and boot it")
        ...
        @Option(name: [.short, .long], help: "Name for the mac-container-tool machine")
        public var name: String?

        @Flag(name: .long, help: "Set this mac-container-tool machine as the default")
        public var setDefault: Bool = false

        @Flag(name: .long, help: "Create the mac-container-tool machine without booting it")
        ...
        public func run() async throws {
            ...
            let defaultConfig = mac-container-toolSystemConfig.machine
