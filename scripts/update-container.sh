...
check_installed_version() {
    ...
    if command -v mac-container-tool &>/dev/null; then
        local installed_version
        installed_version=$(mac-container-tool --version | awk '{print $4}')
...
usage() {
    ...
    echo "Update mac-container-tool"
    echo
    echo "Options:"
...
if [[ "$LATEST" == true ]]; then
    RELEASE_URL="https://api.github.com/repos/apple/mac-container-tool/releases/latest"
    ...
    RELEASE_URL="https://api.github.com/repos/apple/mac-container-tool/releases/tags/$VERSION"
...
SIGNED_PRIMARY_PKG="mac-container-tool-installer-signed.pkg"
SIGNED_FALLBACK_PKG="mac-container-tool-$RELEASE_VERSION-installer-signed.pkg"
UNSIGNED_PRIMARY_PKG="mac-container-tool-installer-unsigned.pkg"
UNSIGNED_FALLBACK_PKG="mac-container-tool-$RELEASE_VERSION-installer-unsigned.pkg"
...
mac-container-tool --version || error "'mac-container-tool' command not found"
