...
public enum NetworkRoutes: String {
    ...
    case status = "com.apple.mac-container-tool.network/status"
    /// Allocates parameters for attaching a sandbox to the network.
    case allocate = "com.apple.mac-container-tool.network/allocate"
    /// Retrieves the allocation for a hostname.
    case lookup = "com.apple.mac-container-tool.network/lookup"
}
