...
extension Application.VolumeCommand {
    public struct VolumePrune: AsyncLoggableCommand {
        ...
        public static let configuration = CommandConfiguration(
            commandName: "prune",
            abstract: "Remove volumes with no mac-container-tool references")
        ...
        public func run() async throws {
            ...
            // Find all volumes not used by any mac-container-tool
            let client = ContainerClient()
            let mac-container-tools = try await client.list()
