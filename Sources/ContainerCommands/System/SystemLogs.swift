...
extension Application {
    public struct SystemLogs: AsyncLoggableCommand {
        public static let subsystem = "com.apple.mac-container-tool"

        public static let configuration = CommandConfiguration(
            commandName: "logs",
            abstract: "Fetch system logs for `mac-container-tool` services"
        )
        ...
        public func run() async throws {
            ...
            do {
                ...
                args.append(contentsOf: ["--predicate", "subsystem = 'com.apple.mac-container-tool'"])
