...
extension RuntimeLinuxHelper {
    struct Start: AsyncParsableCommand {
        static let label = "com.apple.mac-container-tool.runtime.mac-container-tool-runtime-linux"

        static let configuration = CommandConfiguration(
            commandName: "start",
            abstract: "Start helper for a Linux mac-container-tool"
        )
        ...
        func run() async throws {
            ...
            do {
                ...
                var interfaceStrategies: [NetworkInterfaceKey: InterfaceStrategy] = [
                    NetworkInterfaceKey(plugin: "mac-container-tool-network-vmnet", variant: "allocationOnly"): IsolatedInterfaceStrategy()
                ]
                if #available(macOS 26, *) {
                    interfaceStrategies[NetworkInterfaceKey(plugin: "mac-container-tool-network-vmnet", variant: "reserved")] = NonisolatedInterfaceStrategy(log: log)
                }
