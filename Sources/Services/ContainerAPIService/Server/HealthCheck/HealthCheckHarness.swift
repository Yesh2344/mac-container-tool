...
public actor HealthCheckHarness {
    ...
    public func ping(_ message: XPCMessage) async -> XPCMessage {
        ...
        reply.set(key: .apiServerVersion, value: ReleaseVersion.singleLine(appName: "mac-container-tool-apiserver"))
        ...
        reply.set(key: .apiServerAppName, value: "mac-container-tool-apiserver")
        return reply
    }
}
