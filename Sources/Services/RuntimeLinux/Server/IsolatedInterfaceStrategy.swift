...
/// Isolated mac-container-tool network interface strategy. This strategy prohibits
/// mac-container-tool to mac-container-tool networking, but it is the only approach that
...
public struct IsolatedInterfaceStrategy: InterfaceStrategy {
    ...
    public func toInterface(attachment: Attachment, interfaceIndex: Int, additionalData: XPCMessage?) -> Interface {
        ...
        return NATInterface(
            ...
            // https://github.com/apple/mac-container-toolization/pull/38
