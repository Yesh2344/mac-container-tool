...
extension Application {
    public struct MachineStop: AsyncLoggableCommand {
        ...
        public static let configuration = CommandConfiguration(
            commandName: "stop",
            abstract: "Stop a running mac-container-tool machine"
        )
        ...
        @Argument(help: "mac-container-tool machine ID (uses default if not specified)")
        var id: String?
        ...
        public func run() async throws {
            ...
            let progressConfig = try self.progressFlags.makeConfig(
                description: "Stopping mac-container-tool machine"
            )
