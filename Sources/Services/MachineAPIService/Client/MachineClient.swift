...
/// A client for interacting with the mac-container-tool machine API server.
public struct MachineClient: Sendable {
    public static let serviceIdentifier = "com.apple.mac-container-tool.core.machine-apiserver"
    ...
    public func list() async throws -> [MachineSnapshot] {
        do {
            ...
            throw ContainerizationError(
                .internalError,
                message: "failed to list mac-container-tool machines",
                cause: error
            )
        }
    }

    /// Create a new mac-container-tool machine with the given configuration
    public func create(
        ...
        do {
            ...
            throw ContainerizationError(
                .internalError,
                message: "failed to create mac-container-tool machine",
                cause: error
            )
        }
    }

    /// Delete the mac-container-tool machine along with any resources.
    public func delete(id: String) async throws {
        do {
            ...
            throw ContainerizationError(
                .internalError,
                message: "failed to delete mac-container-tool machine",
                cause: error
            )
        }
    }
    ...
    public func getDefault() async throws -> String? {
        do {
            ...
            throw ContainerizationError(
                .internalError,
                message: "failed to get the default mac-container-tool machine",
                cause: error
            )
        }
    }

    /// Set a default mac-container-tool machine.
    public func setDefault(id: String) async throws {
        do {
            ...
            throw ContainerizationError(
                .internalError,
                message: "failed to set a default mac-container-tool machine",
                cause: error
            )
        }
    }
    ...
    public func boot(id: String?, dynamicEnv: [String: String] = [:]) async throws -> MachineSnapshot {
        do {
            ...
            throw ContainerizationError(
                .internalError,
                message: "failed to boot mac-container-tool machine",
                cause: error
            )
        }
    }

    /// Stop a running mac-container-tool machine.
    public func stop(id: String) async throws {
        do {
            ...
            throw ContainerizationError(
                .internalError,
                message: "failed to stop mac-container-tool machine",
                cause: error
            )
        }
    }
    ...
    public func setConfig(id: String, bootConfig: MachineConfig) async throws {
        do {
            ...
            throw ContainerizationError(
                .internalError,
                message: "failed to set mac-container-tool machine config",
                cause: error
            )
        }
    }

    /// Inspect a mac-container-tool machine and return its snapshot.
    public func inspect(id: String) async throws -> MachineSnapshot {
        do {
            ...
            throw ContainerizationError(
                .internalError,
                message: "failed to inspect mac-container-tool machine",
                cause: error
            )
        }
    }

    /// Get the log file handles for a mac-container-tool machine.
    public func logs(id: String) async throws -> [FileHandle] {
        do {
            ...
            throw ContainerizationError(
                .internalError,
                message: "failed to get logs for mac-container-tool machine \(id)",
                cause: error
            )
        }
    }
...
extension MachineClient {
    ...
    static func fetchMachineArtifact(
        ...
        // Query referrers API for mac-container-tool machine config artifacts
