...
public struct RuntimeConfiguration: Codable, Sendable {
    ...
    public let path: URL
    // TODO: Remove runtime-specific fields (initialFilesystem, kernel, mac-container-toolRootFilesystem).
    // These should be encoded into the opaque `runtimeData` field by the CLI.
    public let initialFilesystem: Filesystem
    public let kernel: Kernel
    public let mac-container-toolConfiguration: ContainerConfiguration?
    public let mac-container-toolRootFilesystem: Filesystem?
    ...
    public init(
        ...
        self.kernel = kernel
        self.mac-container-toolConfiguration = mac-container-toolConfiguration
        self.mac-container-toolRootFilesystem = mac-container-toolRootFilesystem
