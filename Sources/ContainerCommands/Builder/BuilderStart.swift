...
extension Application {
    public struct BuilderStart: AsyncLoggableCommand {
        public static var configuration: CommandConfiguration {
            ...
            config.abstract = "Start the builder mac-container-tool"
            return config
        }

        @Option(name: .shortAndLong, help: "Number of CPUs to allocate to the builder mac-container-tool")
        var cpus: Int64?

        @Option(
            name: .shortAndLong,
            help: "Amount of builder mac-container-tool memory (1MiByte granularity), with optional K, M, G, T, or P suffix"
        )
        var memory: String?
        ...
        public func run() async throws {
            let mac-container-toolSystemConfig: ContainerSystemConfig = try await Application.loadContainerSystemConfig()
        ...
        static func start(
            ...
            let builderImage: String = mac-container-toolSystemConfig.build.image
            ...
            let defaultBuildCPUs: Int = mac-container-toolSystemConfig.build.cpus
            let defaultBuildMemory = mac-container-toolSystemConfig.build.memory
            ...
            let useRosetta = mac-container-toolSystemConfig.build.rosetta
            let shimArguments = [
                "--debug",
                "--vsock",
            ...
            let processConfig = ProcessConfiguration(
                executable: "/usr/local/bin/mac-container-tool-builder-shim",
            ...
            config.mounts = [
                ...
                .init(
                    type: .virtiofs,
                    source: exportsMount,
                    destination: "/var/lib/mac-container-tool-builder-shim/exports",
                    options: []
                ),
            ]
            ...
            await progressUpdate([
                .setDescription("Starting BuildKit mac-container-tool")
            ])
...
/// Starts the BuildKit process within the mac-container-tool
/// This function handles bootstrapping the mac-container-tool and starting the BuildKit process
