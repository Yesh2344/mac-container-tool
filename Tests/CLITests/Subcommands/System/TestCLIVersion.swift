...
/// Tests for `mac-container-tool system version` output formats and build type detection.
@Suite(.serialSuites)
final class TestCLIVersion: CLITest {
    ...
    @Test func defaultDisplaysTable() throws {
        ...
        #expect(lines[1].hasPrefix("mac-container-tool"))
    ...
    @Test func jsonFormat() throws {
        ...
        #expect(decoded[0].appName == "mac-container-tool")
