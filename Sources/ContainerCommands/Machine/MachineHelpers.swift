...
/// Resolves a mac-container-tool machine ID from an optional argument, falling back to the default machine.
...
/// Boots a mac-container-tool machine and, on first ever boot, runs the in-VM init script
...
func bootMachine(
    ...
    do {
        ...
        guard exitCode == 0 else {
            throw ContainerizationError(
                .invalidState,
                message: "mac-container-tool machine failed to create user"
            )
        }
    } catch {
