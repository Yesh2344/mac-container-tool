...
/// A mac-container-tool registry resource representing a configured registry endpoint.
///
/// Registry resources store authentication and configuration information for
/// mac-container-tool registries such as Docker Hub, GitHub Container Registry, or
/// private registries.
public struct RegistryResource: ManagedResource {
    ...
    /// See <https://github.com/apple/mac-container-toolization/blob/main/Sources/ContainerizationOCI/Reference.swift>
