...
extension Application {
    public struct ImagePush: AsyncLoggableCommand {
        ...
        public func run() async throws {
            ...
            let image = try await ClientImage.get(reference: reference, mac-container-toolSystemConfig: mac-container-toolSystemConfig)
            ...
            progress.start()
            _ = try await image.push(platform: p, scheme: scheme, mac-container-toolSystemConfig: mac-container-toolSystemConfig, progressUpdate: progress.handler)
            progress.finish()
