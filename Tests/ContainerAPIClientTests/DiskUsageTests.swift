...
struct DiskUsageTests {
    ...
    func testJSONSerialization() throws {
        let stats = DiskUsageStats(
            ...
            mac-container-tools: ResourceUsage(total: 3, active: 2, sizeInBytes: 2048, reclaimable: 1024),
        ...
        #expect(decoded.mac-container-tools.total == stats.mac-container-tools.total)
        #expect(decoded.mac-container-tools.active == stats.mac-container-tools.active)
        #expect(decoded.mac-container-tools.sizeInBytes == stats.mac-container-tools.sizeInBytes)
        #expect(decoded.mac-container-tools.reclaimable == stats.mac-container-tools.reclaimable)
