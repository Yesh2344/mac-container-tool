...
struct BuildRemoteContentProxy: BuildPipelineHandler {
    ...
    enum ContentStoreMethod: String {
        case info = "/mac-container-toold.services.content.v1.Content/Info"
        case readerAt = "/mac-container-toold.services.content.v1.Content/ReaderAt"
        case delete = "/mac-container-toold.services.content.v1.Content/Delete"
        case update = "/mac-container-toold.services.content.v1.Content/Update"
        case walk = "/mac-container-toold.services.content.v1.Content/Walk"
