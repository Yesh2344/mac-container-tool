...
struct RuntimeConfigurationTests {
    ...
    func testRuntimeConfigurationReadWrite() throws {
        ...
        let runtimeConfig = RuntimeConfiguration(
            ...
            kernel: kernel,
            mac-container-toolConfiguration: nil,
            mac-container-toolRootFilesystem: nil,
            options: nil
        )
        ...
        #expect(
            readRuntimeConfig.mac-container-toolConfiguration == nil,
            "Container configuration should be nil")
        #expect(
            readRuntimeConfig.mac-container-toolRootFilesystem == nil,
