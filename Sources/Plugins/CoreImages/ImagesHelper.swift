...
struct ImagesHelper: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
        commandName: "mac-container-tool-core-images",
        abstract: "XPC service for managing OCI images",
        version: ReleaseVersion.singleLine(appName: "mac-container-tool-core-images"),
        subcommands: [
            Start.self
        ]
    )
...
extension ImagesHelper {
    struct Start: AsyncParsableCommand {
        ...
        var serviceIdentifier: String = "com.apple.mac-container-tool.core.mac-container-tool-core-images"
        ...
        func run() async throws {
            ...
            do {
                ...
                try self.initializeImagesService(root: appRoot, mac-container-toolSystemConfig: mac-container-toolSystemConfig, log: log, routes: &routes)
                let xpc = XPCServer(
        ...
        private func initializeImagesService(root: FilePath, mac-container-toolSystemConfig: ContainerSystemConfig, log: Logger, routes: inout [String: XPCServer.RouteHandler]) throws {
            ...
            let unpackStrategy = SnapshotStore.defaultUnpackStrategy(initImage: mac-container-toolSystemConfig.vminit.image)
