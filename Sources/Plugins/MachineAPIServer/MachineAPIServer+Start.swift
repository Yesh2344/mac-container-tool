...
extension MachineAPIServer {
    struct Start: AsyncParsableCommand {
        private static let commandName = "mac-container-tool-machine-apiserver"
        private static let logFile = FilePath.Component("mac-container-tool-machine-apiserver.log")
