...
public struct Flags {
    ...
    public struct Process: ParsableArguments {
        ...
        @Option(
            ...
            help: .init(
                "Set the initial working directory inside the mac-container-tool",
                valueName: "dir"
            )
        )
    ...
    public struct Resource: ParsableArguments {
        ...
        @Option(name: .shortAndLong, help: "Number of CPUs to allocate to the mac-container-tool")
    ...
    public struct Registry: ParsableArguments {
        ...
        @Option(help: "Scheme to use when connecting to the mac-container-tool registry. One of (http, https, auto)")
    ...
    public struct Management: ParsableArguments {
        ...
        @Option(name: .long, help: "Write the mac-container-tool ID to the path provided")
        public var cidfile = ""

        @Flag(name: .shortAndLong, help: "Run the mac-container-tool and detach from the process")
        ...
        @Flag(name: .customLong("init"), help: "Run an init process inside the mac-container-tool that forwards signals and reaps processes")
        ...
        @Option(name: [.short, .customLong("label")], help: "Add a key=value label to the mac-container-tool")
        public var labels: [String] = []

        @Option(name: .customLong("mount"), help: "Add a mount to the mac-container-tool (format: type=<>,source=<>,target=<>,readonly)")
        public var mounts: [String] = []

        @Option(name: .long, help: "Use the specified name as the mac-container-tool ID")
        public var name: String?

        @Option(name: [.customLong("network")], help: "Attach the mac-container-tool to a network (format: <name>[,mac=XX:XX:XX:XX:XX:XX][,mtu=VALUE])")
        public var networks: [String] = []

        @Flag(name: [.customLong("no-dns")], help: "Do not configure DNS in the mac-container-tool")
        ...
        @Option(
            ...
            help: .init(
                "Publish a port from mac-container-tool to host (format: [host-ip:]host-port:mac-container-tool-port[/protocol])",
                valueName: "spec"
            )
        )
        ...
        @Option(
            ...
            help: .init(
                "Publish a socket from mac-container-tool to host (format: host_path:mac-container-tool_path)",
                valueName: "spec"
            )
        )
        public var publishSockets: [String] = []

        @Flag(name: .long, help: "Mount the mac-container-tool's root filesystem as read-only")
        public var readOnly = false

        @Flag(name: [.customLong("rm"), .long], help: "Remove the mac-container-tool after it stops")
        public var remove = false

        @Flag(name: .long, help: "Enable Rosetta in the mac-container-tool")
        public var rosetta = false

        @Option(name: .long, help: "Set the runtime handler for the mac-container-tool (default: mac-container-tool-runtime-linux)")
        public var runtime: String?

        @Flag(name: .long, help: "Forward SSH agent socket to mac-container-tool")
        public var ssh = false

        @Option(name: .customLong("shm-size"), help: "Size of /dev/shm (e.g. 64M, 1G)")
        public var shmSize: String?

        @Option(name: .customLong("tmpfs"), help: "Add a tmpfs mount to the mac-container-tool at the given path")
        public var tmpFs: [String] = []

        @Flag(
            name: .long,
            help:
                "Expose virtualization capabilities to the mac-container-tool (requires host and guest support)"
        )
        public var virtualization: Bool = false

        @Option(name: [.customLong("volume"), .short], help: "Bind mount a volume into the mac-container-tool")
