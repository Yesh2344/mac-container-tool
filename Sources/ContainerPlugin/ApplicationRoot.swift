...
public struct ApplicationRoot {
    ...
    /// Otherwise, the system uses the default "~/Library/Application Support/com.apple.mac-container-tool".
    public static let environmentName = "CONTAINER_APP_ROOT"

    /// The default root directory used when ``environmentName`` is not set:
    /// `~/Library/Application Support/com.apple.mac-container-tool`.
    ...
    .appending(FilePath.Component("com.apple.mac-container-tool"))
