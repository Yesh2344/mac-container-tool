...
public struct DiskUsageStats: Sendable, Codable {
    ...
    /// Disk usage for mac-container-tools
    public var mac-container-tools: ResourceUsage

    /// Disk usage for volumes
    public var volumes: ResourceUsage

    public init(images: ResourceUsage, mac-container-tools: ResourceUsage, volumes: ResourceUsage) {
        self.images = images
        self.mac-container-tools = mac-container-tools
