...
public struct PluginConfig: Sendable, Codable {
    ...
    public enum DaemonPluginType: String, Sendable, Codable {
        ...
        /// of a **single** mac-container-tool can be managed.
        ...
        /// for a given mac-container-tool such that the client can communicate with it given an instance id.
        case runtime
    ...
    public struct Service: Sendable, Codable {
        ...
        /// `com.apple.mac-container-tool.{type}.{name}.[{id}]` for
