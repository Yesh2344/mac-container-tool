...
extension Application {
    public struct ImagePull: AsyncLoggableCommand {
        ...
        public func run() async throws {
            ...
            let processedReference = try ClientImage.normalizeReference(reference, mac-container-toolSystemConfig: mac-container-toolSystemConfig)
            ...
            let image = try await ClientImage.pull(
                reference: processedReference, platform: p, scheme: scheme, mac-container-toolSystemConfig: mac-container-toolSystemConfig,
