...
public enum MachineKeys: String {
    ...
    /// List of mac-container-tool machine snapshots.
    case machines
    /// Single mac-container-tool machine snapshot.
    case snapshot
    /// Boot-time configuration.
    case bootConfig
    /// File handles to logs
    case logs
    /// Special-case environment variables recomputed on mac-container-tool machine start
    case dynamicEnv
}
