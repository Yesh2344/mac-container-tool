...
/// A client for interacting with a mac-container-tool runtime service instance.
public struct RuntimeClient: Sendable {
    static let label = "com.apple.mac-container-tool.runtime"
    ...
    public static func create(id: String, runtime: String, timeout: Duration = XPCClient.xpcRegistrationTimeout) async throws -> RuntimeClient {
        ...
        do {
            ...
            throw ContainerizationError(
                .internalError,
                message: "failed to create mac-container-tool \(id)",
                cause: error
            )
        }
...
extension RuntimeClient {
    public func bootstrap(
        ...
        do {
            ...
            throw ContainerizationError(
                .internalError,
                message: "failed to bootstrap mac-container-tool \(self.id)",
                cause: error
            )
        }
    }
    ...
    public func state() async throws -> SandboxSnapshot {
        ...
        do {
            ...
            throw ContainerizationError(
                .internalError,
                message: "failed to get state for mac-container-tool \(self.id)",
                cause: error
            )
        }
    ...
    public func createProcess(_ id: String, config: ProcessConfiguration, stdio: [FileHandle?]) async throws {
        ...
        do {
            ...
            throw ContainerizationError(
                .internalError,
                message: "failed to create process \(id) in mac-container-tool \(self.id)",
                cause: error
            )
        }
    }
    ...
    public func startProcess(_ id: String) async throws {
        ...
        do {
            ...
            throw ContainerizationError(
                .internalError,
                message: "failed to start process \(id) in mac-container-tool \(self.id)",
                cause: error
            )
        }
    }
    ...
    public func stop(options: ContainerStopOptions) async throws {
        ...
        do {
            ...
            throw ContainerizationError(
                .internalError,
                message: "failed to stop mac-container-tool \(self.id)",
                cause: error
            )
        }
    }
    ...
    public func kill(_ id: String, signal: String) async throws {
        ...
        do {
            ...
            throw ContainerizationError(
                .internalError,
                message: "failed to send signal \(signal) to process \(id) in mac-container-tool \(self.id)",
                cause: error
            )
        }
    }
    ...
    public func resize(_ id: String, size: Terminal.Size) async throws {
        ...
        do {
            ...
            throw ContainerizationError(
                .internalError,
                message: "failed to resize pty for process \(id) in mac-container-tool \(self.id)",
                cause: error
            )
        }
    }
    ...
    public func wait(_ id: String) async throws -> ExitStatus {
        ...
        do {
            ...
            throw ContainerizationError(
                .internalError,
                message: "failed to wait for process \(id) in mac-container-tool \(self.id)",
                cause: error
            )
        }
    ...
    public func shutdown() async throws {
        ...
        do {
            ...
            throw ContainerizationError(
                .internalError,
                message: "failed to shutdown mac-container-tool \(self.id)",
                cause: error
            )
        }
    }
    ...
    public func copyIn(source: String, destination: String, mode: UInt32, createParents: Bool = true) async throws {
        ...
        do {
            ...
            throw ContainerizationError(
                .internalError,
                message: "failed to copy into mac-container-tool \(self.id)",
                cause: error
            )
        }
    }
    ...
    public func copyOut(source: String, destination: String, createParents: Bool = true) async throws {
        ...
        do {
            ...
            throw ContainerizationError(
                .internalError,
                message: "failed to copy from mac-container-tool \(self.id)",
                cause: error
            )
        }
    }
    ...
    public func statistics() async throws -> ContainerStats {
        ...
        do {
            ...
            throw ContainerizationError(
                .internalError,
                message: "failed to get statistics for mac-container-tool \(self.id)",
                cause: error
            )
        }
