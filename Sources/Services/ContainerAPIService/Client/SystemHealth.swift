...
/// Snapshot of the health of mac-container-tool services and resources
public struct SystemHealth: Sendable, Codable {
    ...
    /// The release version of the mac-container-tool services.
    public let apiServerVersion: String

    /// The Git commit ID for the mac-container-tool services.
