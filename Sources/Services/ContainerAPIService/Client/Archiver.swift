...
extension WriteEntry: @retroactive Encodable {
    ...
    public func encode(to encoder: any Encoder) throws {
        ...
        try mac-container-tool.encodeIfPresent(fileType.rawValue, forKey: .fileType)
        try mac-container-tool.encodeIfPresent(permissions, forKey: .permissions)
        try mac-container-tool.encodeIfPresent(path, forKey: .path)
        try mac-container-tool.encodeIfPresent(size, forKey: .size)
        try mac-container-tool.encodeIfPresent(owner, forKey: .owner)
        try mac-container-tool.encodeIfPresent(group, forKey: .group)
        try mac-container-tool.encodeIfPresent(symlinkTarget, forKey: .symlinkTarget)
        try mac-container-tool.encodeIfPresent(hardlink, forKey: .hardlink)
        try mac-container-tool.encodeIfPresent(creationDate, forKey: .creationDate)
        try mac-container-tool.encodeIfPresent(modificationDate, forKey: .modificationDate)
        try mac-container-tool.encodeIfPresent(contentAccessDate, forKey: .contentAccessDate)
    }
}
