...
extension Application {
    public struct ContainerExec: AsyncLoggableCommand {
        ...
        public static let configuration = CommandConfiguration(
            commandName: "exec",
            abstract: "Run a new command in a running mac-container-tool")
        ...
        public func run() async throws {
            ...
            try ensureRunning(mac-container-tool: mac-container-tool)

            let stdin = self.processFlags.interactive
            let tty = self.processFlags.tty

            var config = mac-container-tool.configuration.initProcess
            ...
            do {
                ...
                let process = try await client.createProcess(
                    mac-container-toolId: mac-container-tool.id,
