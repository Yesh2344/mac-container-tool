...
BUILDER_SHIM_REPO ?= https://github.com/apple/mac-container-tool-builder-shim.git
...
clean-proto-tools:
	...
	@rm -rf $(LOCAL_DIR)/mac-container-tool-builder-shim
