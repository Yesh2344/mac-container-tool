...
/// A mac-container-tool as a managed resource. Wraps the persistent
...
public struct ManagedContainer: ManagedResource {
    ...
    public var name: String { configuration.id }  // mac-container-tools have no separate name field today
    ...
    /// Mint ids the way mac-container-tools actually mint them (lowercased UUID),
...
extension ManagedContainer {
    ...
    public func encode(to encoder: Encoder) throws {
        var c = encoder.mac-container-tool(keyedBy: CodingKeys.self)
