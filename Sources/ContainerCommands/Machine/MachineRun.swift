...
extension Application {
    public struct MachineRun: AsyncLoggableCommand {
        ...
        public static let configuration = CommandConfiguration(
            commandName: "run",
            abstract: "Run a command or interactive shell in a mac-container-tool machine, booting the mac-container-tool machine if necessary"
        )
        ...
        @Flag(name: .shortAndLong, help: "Run a process in a mac-container-tool machine and detach from it")
        ...
        public func run() async throws {
            ...
            let mac-container-toolClient = ContainerClient()
            ...
            guard let mac-container-toolId = snapshot.mac-container-toolId else {
                throw ContainerizationError(
                    .invalidState,
                    message: "mac-container-tool machine is running but has no mac-container-tool ID"
                )
            }
            ...
            let process = try await mac-container-toolClient.createProcess(
                mac-container-toolId: mac-container-toolId,
