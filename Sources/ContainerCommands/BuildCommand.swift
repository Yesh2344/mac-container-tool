...
extension Application {
    public struct BuildCommand: AsyncLoggableCommand {
        ...
        public static var configuration: CommandConfiguration {
            ...
            config._superCommandName = "mac-container-tool"
        ...
        public func run() async throws {
            ...
            do {
                ...
                // BUG: See https://github.com/apple/mac-container-tool/issues/735.
                ...
                guard buildFileData.count < maxDockerfileSize else {
                    throw ContainerizationError(
                        ...
                        message: """
                            ...
                            See https://github.com/apple/mac-container-tool/issues/735.
                            """
                    )
                }
